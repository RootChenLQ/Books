...
<tr>
<td width="58%">
<img src="case_16_robust_control_ai_diagram.png" alt="案例16：鲁棒控制（H∞ & 滑模控制）系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 案例简介：本案例演示**鲁棒控制**技术在运河系统中的应用。鲁棒控制是一类专门处理系统不确定性和外部扰动的控制方法，能够在参数摄动、未建模动态、外部干扰等不利因素下保持良好的性能。
- H∞控制理论：H∞控制基本思想
- 滑模控制理论：滑模控制基本思想
- 运河系统的鲁棒控制设计：运河系统不确定性建模
