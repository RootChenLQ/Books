...
<tr>
<td width="58%">
<img src="case11_anomaly_detection_ai_diagram.png" alt="案例4.2：水质异常智能检测系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 工程背景：供水系统的水质监测至关重要。传统的水质监测依赖人工采样和化验，周期长、成本高。本案例利用在线监测数据（pH、浊度、余氯、电导率等），采用机器学习方法进行实时异常检测，及时发现水质问题。
- 案例目标：理解异常检测的基本原理
- 主要内容：水质监测指标
