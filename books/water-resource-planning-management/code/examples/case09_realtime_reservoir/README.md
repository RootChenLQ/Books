...
<tr>
<td width="58%">
<img src="case09_realtime_reservoir_ai_diagram.png" alt="案例3.3：水库群实时优化调度系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 工程背景：某流域梯级水库群需要根据实时来水、用水需求和电力负荷进行动态调度。系统需要在满足防洪、发电、供水等多目标约束下，实现最优运行。实时调度需要快速响应，考虑预测误差和不确定性。
- 案例目标：理解水库群实时调度特点
- 主要内容：水库群系统
- 核心算法：MPC滚动优化
