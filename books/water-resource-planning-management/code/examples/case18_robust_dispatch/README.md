...
<tr>
<td width="58%">
<img src="case18_robust_dispatch_ai_diagram.png" alt="案例6.3：鲁棒优化调度系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 工程背景：在入流、负荷等不确定因素下，传统确定性优化可能产生"最优但脆弱"的调度方案。鲁棒优化追求在最坏情景下仍能保持可接受性能的方案，提高系统抗风险能力。
- 案例目标：理解鲁棒优化的基本思想
- 主要内容：鲁棒优化思想
- 核心算法：Min-Max鲁棒优化
