...
<tr>
<td width="58%">
<img src="case02_water_demand_forecasting_ai_diagram.png" alt="案例1.2：城市需水预测系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 工程背景：某城市（现状人口300万）正在编制2025-2050年水资源规划，需要对未来25年的需水量进行科学预测。城市包含生活、工业、服务业和生态用水等多种需水类型。本案例将综合运用多种预测方法，给出不同情景下的需水量…
- 案例目标：掌握多种需水预测方法
- 主要内容：定额法预测
- 数据说明：输入数据
