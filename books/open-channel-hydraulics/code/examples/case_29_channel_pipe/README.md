...
<tr>
<td width="58%">
<img src="case_29_channel_pipe_ai_diagram.png" alt="案例29：渠道-管道耦合系统系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 案例背景：某灌溉系统由明渠和压力管道组成。明渠长L_c=500 m，矩形断面b×h=2.0×1.5 m，坡度S₀=0.0005，Manning系数n=0.015。明渠末端通过进水池连接压力管道，管道长L_p=300 m…
- 核心理论：明渠段计算
- 计算任务：任务1：明渠正常水深
