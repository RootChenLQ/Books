...
<tr>
<td width="58%">
<img src="case_21_pipe_flow_ai_diagram.png" alt="案例21：城市供水管道水力计算系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 案例背景：某城市新建住宅小区需要设计供水管道系统。已知设计流量Q=50 L/s，管道长度L=500 m，管道材质为钢管（粗糙度ε=0.05 mm）。需要计算管道沿程水头损失，并选择合理的管径。
- 学习目标：掌握达西-魏斯巴赫公式
- 核心理论：达西-魏斯巴赫公式（Darcy-Weisbach Formula）
- 计算任务：任务1：不同管径的水力计算
