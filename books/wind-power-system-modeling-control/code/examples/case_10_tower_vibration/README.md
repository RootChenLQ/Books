...
<tr>
<td width="58%">
<img src="case_10_tower_vibration_ai_diagram.png" alt="案例10: 塔架振动系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 简介：本案例研究风力机塔架的振动特性与疲劳载荷分析，这是结构设计和载荷评估的核心内容。采用单自由度简化模型描述塔架的前后振动，演示塔架的模态分析(固有频率、阻尼比)、风载荷激励下的振动响应以及疲劳分析的基本方法。塔架振…
- 理论背景：风力机塔架通常简化为悬臂梁模型，前后(FA)方向的第一阶模态是主导振动模式。单自由度模型的运动方程为：m·ẍ + c·ẋ + k·x = F(t)，其中m为等效质量(约300吨)，k为等效刚度(约5 MN/m…
- 代码说明：主要类
- 参数说明：塔架参数
