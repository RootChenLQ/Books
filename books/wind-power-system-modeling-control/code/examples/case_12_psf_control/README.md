...
<tr>
<td width="58%">
<img src="case_12_psf_control_ai_diagram.png" alt="案例12: 功率信号反馈控制 (PSF Control)系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 简介：本案例研究功率信号反馈(Power Signal Feedback, PSF)控制策略，这是一种无需风速测量的最大功率点跟踪(MPPT)方法。PSF控制基于最优转矩曲线T_opt = Kopt×ω²，通过测量转速…
- 理论背景：PSF控制的理论基础是：当风轮工作在最优叶尖速比λ_opt时，功率P = (1/2)ρπR²v³Cp_max，而λ_opt = ωR/v，代入消去风速v可得P = (1/2)ρπR⁵(ω/λ_opt)³Cp_…
- 代码说明：主要类
- 参数说明：风轮参数
