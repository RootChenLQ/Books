...
<tr>
<td width="58%">
<img src="case_03_blade_aerodynamics_ai_diagram.png" alt="案例3: 叶片气动力计算系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 简介：本案例演示风力机叶片气动力学的核心理论和计算方法，包括翼型气动特性分析、叶素动量理论(BEM)求解、诱导因子计算以及风轮性能曲线(Cp-λ)的绘制。通过本案例，您将深入理解风力机气动设计的基础原理，掌握从翼型选择…
- 理论背景：叶片气动力学是风力机设计的核心。翼型的升力系数(Cl)和阻力系数(Cd)决定了叶片截面的气动性能。叶素动量理论(Blade Element Momentum Theory, BEM)是最广泛使用的风轮气动分析…
- 代码说明：主要类和函数
- 参数说明：风轮参数
