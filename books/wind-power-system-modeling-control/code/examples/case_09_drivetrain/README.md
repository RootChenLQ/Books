...
<tr>
<td width="58%">
<img src="case_09_drivetrain_ai_diagram.png" alt="案例9: 传动系统建模系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 简介：本案例研究风力机传动系统的动力学建模与振动分析，这对于疲劳载荷评估和控制系统设计至关重要。采用两质量模型描述风轮惯量、齿轮箱和发电机惯量之间通过弹性轴连接的动力学特性。案例演示传动系统对转矩阶跃的瞬态响应、轴扭振…
- 理论背景：两质量模型是风力机传动系统最常用的简化模型。风轮侧惯量Jt(约10^7 kg·m²)和发电机侧惯量Jg(约10^5 kg·m²，折算到低速轴)通过弹性轴连接，轴刚度Ks(约10^8 N·m/rad)和阻尼Cs…
- 代码说明：主要类
- 参数说明：传动系统参数
