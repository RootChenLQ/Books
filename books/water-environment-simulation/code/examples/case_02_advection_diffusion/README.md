...
<tr>
<td width="58%">
<img src="case_02_advection_diffusion_ai_diagram.png" alt="案例2：示踪剂在渠道中的对流-扩散系统示意图" width="100%"/>
</td>
<td width="42%">

**AI大模型总结要点**

- 案例背景：某灌溉渠道（长100m，宽5m，深1.5m），流速 u = 0.5 m/s。在上游（x=10m）处瞬时投放示踪剂（荧光染料），监测下游浓度分布。
- 学习目标：理解对流-扩散过程
- 核心理论：对流-扩散方程
- 计算任务：任务1：数值格式对比
